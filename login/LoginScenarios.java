...
public class LoginScenarios extends ExtentReportBaseClass {
	...
	public void WrongPasswordTest() {
		...
		driver.findElementByXPath("//*[@id=\"password\"]").sendKeys("admin1");
		...
		wait.until(ExpectedConditions.textToBePresentInElement(
				driver.findElementByXPath("//*[@id=\"root\"]/main/div/div/div/div[2]/div/label[3]"),
				"Invalid username or password"));

		sf.assertEquals(driver.findElementByXPath("//*[@id=\"root\"]/main/div/div/div/div[2]/div/label[3]").getText(),
				"Invalid username or password");
		driver.close();
	...
	public void LoginEmptyTest() {
		...
		WebDriverWait wait = new WebDriverWait(driver, 30);
		wait.until(ExpectedConditions.textToBePresentInElement(
				driver.findElementByXPath("//*[@id=\'email-helper-text\']"), "Incorrect Username"));
		wait.until(ExpectedConditions.textToBePresentInElement(
				driver.findElementByXPath("//*[@id=\'password-helper-text\']"),
				"Password is required and must not be less than 4 characters"));
		sf.assertEquals(driver.findElementById("email-helper-text").getText(), "Incorrect Username");
		sf.assertEquals(driver.findElementById("password-helper-text").getText(),
				"Password is required and must not be less than 4 characters");
		driver.close();
	...
	public void LogoutTest() {
		...
		driver.findElementByCssSelector("#root > div.jss5.jss6 > header > div > svg:nth-child(5)").click();
		// #root > div.jss5.jss6 > header > div > svg:nth-child(5)
		// #root > div.makeStyles-root-5.makeStyles-shiftContent-6 > header > div > svg
		wait.until(ExpectedConditions
				.elementToBeClickable(driver.findElementByXPath("/html/body/div[2]/div[3]/div/div[3]/button[2]")));
